...
{
    {lus::lex::mnemonic::Null,                     color::white},
    {lus::lex::mnemonic::LeftShift,               color::skyblue1},
    {lus::lex::mnemonic::Radical,                  color::deepskyblue7},
    {lus::lex::mnemonic::Exponent,                 color::deepskyblue7},
    {lus::lex::mnemonic::RightShift,              color::skyblue1},
    {lus::lex::mnemonic::Decr,                     color::dodgerblue1},
    {lus::lex::mnemonic::Incr,                     color::dodgerblue1},
    {lus::lex::mnemonic::AssignAdd,               color::salmon1},
    {lus::lex::mnemonic::AssignSub,               color::salmon1},
    {lus::lex::mnemonic::AssignMul,               color::salmon1},
    {lus::lex::mnemonic::AssignDiv,               color::salmon1},
    {lus::lex::mnemonic::AssignMod,               color::salmon1},
    {lus::lex::mnemonic::AssignAnd,               color::salmon1},
    {lus::lex::mnemonic::AssignOr,                color::salmon1},
    {lus::lex::mnemonic::AssignXor,               color::salmon1},
    {lus::lex::mnemonic::AssignC1,                color::salmon1},
    {lus::lex::mnemonic::AssignLeftShift,        color::salmon1},
    {lus::lex::mnemonic::AssignRightShift,       color::salmon1},
    {lus::lex::mnemonic::Deref,                    color::white},
    {lus::lex::mnemonic::LessEq,                  color::lighcoreateblue},
    {lus::lex::mnemonic::GreaterEq,               color::lighcoreateblue},
    {lus::lex::mnemonic::Equal,                    color::lighcoreateblue},
    {lus::lex::mnemonic::NotEqual,                color::lighcoreateblue},
    {lus::lex::mnemonic::Add,                      color::darkorange3},
    {lus::lex::mnemonic::Sub,                      color::darkorange3},
    {lus::lex::mnemonic::Mul,                      color::deepskyblue7},
    {lus::lex::mnemonic::Indirection,              color::white},
    {lus::lex::mnemonic::CommentCpp,              color::white},
    {lus::lex::mnemonic::Modulo,                   color::lighcoreateblue},
    {lus::lex::mnemonic::LessThan,                color::lighcoreateblue},
    {lus::lex::mnemonic::GreaterThan,             color::lighcoreateblue},
    {lus::lex::mnemonic::Assign,                   color::salmon1},
    {lus::lex::mnemonic::BinaryAnd,               color::skyblue1},
    {lus::lex::mnemonic::BinaryOr,                color::skyblue1},
    {lus::lex::mnemonic::BinaryXor,               color::skyblue1},
    {lus::lex::mnemonic::C1,                       color::skyblue1},
    {lus::lex::mnemonic::C2,                       color::skyblue1},
    {lus::lex::mnemonic::BinaryNot,               color::skyblue1},
    {lus::lex::mnemonic::LogicalAnd,              color::lighcoreateblue},
    {lus::lex::mnemonic::LogicalOr,               color::lighcoreateblue},
    {lus::lex::mnemonic::OpenAbsOp,              color::lightsteelblue},
    {lus::lex::mnemonic::CloseAbsOp,             color::lightsteelblue},
    {lus::lex::mnemonic::OpenPar,                 color::gold4},
    {lus::lex::mnemonic::ClosePar,                color::gold4},
    {lus::lex::mnemonic::OpenIndex,                  color::darkolivegreen2},
    {lus::lex::mnemonic::CloseIndex,                 color::darkolivegreen2},
    {lus::lex::mnemonic::OpenBrace,                  color::grey69},
    {lus::lex::mnemonic::CloseBrace,                 color::grey69},
    {lus::lex::mnemonic::BeginComment,            color::orange3},
    {lus::lex::mnemonic::EndComment,              color::orange3},
    {lus::lex::mnemonic::Div,                      color::deepskyblue7},
    {lus::lex::mnemonic::Comma,                    color::violet},
    {lus::lex::mnemonic::Scope,                    color::violet},
    {lus::lex::mnemonic::Semicolon,                color::violet},
    {lus::lex::mnemonic::Colon,                    color::violet},
    {lus::lex::mnemonic::Range,                    color::violet},
    {lus::lex::mnemonic::Factorial,                color::deepskyblue4},
    {lus::lex::mnemonic::Positive,                 color::white},
    {lus::lex::mnemonic::Negative,                 color::white},
   {lus::lex::mnemonic::SQuote,                   color::white},
   {lus::lex::mnemonic::DQuote,                   color::white},
    {lus::lex::mnemonic::Ternary,                  color::white},
    {lus::lex::mnemonic::Hash,                     color::white},
    {lus::lex::mnemonic::Eos,                      color::white},
    {lus::lex::mnemonic::Dot,                      color::violet},
    {lus::lex::mnemonic::Return,                   color::dodgerblue2},
    {lus::lex::mnemonic::If,                       color::dodgerblue2},
    {lus::lex::mnemonic::Pi,                       color::gold1},
    {lus::lex::mnemonic::Number,                   color::aquamarine2},
    {lus::lex::mnemonic::U8,                       color::aquamarine2},
    {lus::lex::mnemonic::U16,                      color::aquamarine2},
    {lus::lex::mnemonic::U32,                      color::aquamarine2},
    {lus::lex::mnemonic::U64,                      color::aquamarine2},
    {lus::lex::mnemonic::I8,                       color::aquamarine2},
    {lus::lex::mnemonic::I16,                      color::aquamarine2},
    {lus::lex::mnemonic::I32,                      color::aquamarine2},
    {lus::lex::mnemonic::I64,                      color::aquamarine2},
    {lus::lex::mnemonic::Float,                    color::aquamarine2},
    {lus::lex::mnemonic::String,                   color::aquamarine2},
    {lus::lex::mnemonic::Then,                     color::dodgerblue2},
    {lus::lex::mnemonic::Else,                     color::dodgerblue2},
    {lus::lex::mnemonic::Const,                    color::white},
    {lus::lex::mnemonic::Include,                  color::white},
    //{lus::lex::mnemonic::Module,                   color::white},
    {lus::lex::mnemonic::At,                       color::white},
    {lus::lex::mnemonic::Prime,                    color::white},
    {lus::lex::mnemonic::Do,                       color::dodgerblue2},
    {lus::lex::mnemonic::While,                    color::dodgerblue2},
    {lus::lex::mnemonic::For,                      color::dodgerblue2},
    {lus::lex::mnemonic::Until,                    color::dodgerblue2},
    {lus::lex::mnemonic::Repeat,                   color::dodgerblue2},
    {lus::lex::mnemonic::Switch,                   color::dodgerblue2},
    {lus::lex::mnemonic::Case,                     color::dodgerblue2},
    {lus::lex::mnemonic::Type,                     color::white},
    {lus::lex::mnemonic::LowHex,                  color::white},
    {lus::lex::mnemonic::UpHex,                   color::white},
    {lus::lex::mnemonic::Cosinus,                  color::springgreen4},
    {lus::lex::mnemonic::ArcCosinus,              color::springgreen4},
    {lus::lex::mnemonic::Tangent,                  color::springgreen4},
    {lus::lex::mnemonic::ArcTangent,              color::springgreen4},
    {lus::lex::mnemonic::Sinus,                    color::springgreen4},
    {lus::lex::mnemonic::ArcSinus,                color::springgreen4},
    {lus::lex::mnemonic::Object,                   color::springgreen4},
    {lus::lex::mnemonic::Static,                   color::grey70},
    {lus::lex::mnemonic::This,                     color::springgreen4},
    {lus::lex::mnemonic::UnShadow,                 color::white},
    {lus::lex::mnemonic::Catch,                    color::yellow5},
    {lus::lex::mnemonic::Throw,                    color::yellow5},
    {lus::lex::mnemonic::Noop,                      color::yellow5}
...
{
    {lus::lex::type::Assign,    color::cadetblue},
    {lus::lex::type::Number,    color::cyan2},
    {lus::lex::type::Keyword,   color::cornflowerblue},
    {lus::lex::type::Operator,  color::lightcoral},
    {lus::lex::type::Binary,    color::cornsilk1},
    {lus::lex::type::Text,      color::darkslategray3},
    {lus::lex::type::Id,        color::white},
    {lus::lex::type::Punc,      color::yellow},
    {lus::lex::type::Prefix,    color::cadetblue},
    //...
};
...
[[maybe_unused]] size_t token_table::set_reference_table()
{
    if(!ref_table.empty())
    {
        log::warning() << log::code::notempty << log::fn::func;
    }
...
{
    log::debug() << " Dump the Tokens Product Table:" << log::fn::endl;
